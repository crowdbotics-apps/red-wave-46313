"""
Django settings for red_wave_46313 project.
...
ROOT_URLCONF = 'red_wave_46313.urls'
...
WSGI_APPLICATION = 'red_wave_46313.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "red_wave_46313 API",
    "DESCRIPTION": "API documentation for red_wave_46313 App",
    "VERSION": "v1",
}
